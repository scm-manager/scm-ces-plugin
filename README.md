...
Offers integration for the Cloudogu Ecosystem

## Usage

Find out how this plugin works on the [plugin documentation page](https://www.scm-manager.org/plugins/scm-ces-plugin/docs/).
